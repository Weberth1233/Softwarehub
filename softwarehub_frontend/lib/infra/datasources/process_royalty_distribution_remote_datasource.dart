...
abstract class IProcessRoyaltyDistributionRemoteDatasource implements IGenericPostRemoteDatasource<ProcessRoyaltyDistributionRequestEntity>{
}

class ProcessRoyaltyDistributionRemoteDatasource implements IProcessRoyaltyDistributionRemoteDatasource {
...
Future<String> post(ProcessRoyaltyDistributionRequestEntity entity) {
  ...
  return helper.post<String>(
    ...
    errorMessage: "Erro ao cadastrar distrbuição de cotas!",
