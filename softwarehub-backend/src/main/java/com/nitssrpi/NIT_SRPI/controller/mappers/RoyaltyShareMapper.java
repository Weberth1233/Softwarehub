...
public interface RoyaltyShareMapper {
    ...
    @Mapping(target = "externalAuthor", source = "externalAuthorId")
    ...
    @Mapping(target = "externalAuthorId", source = "externalAuthor.id")
    @Mapping(target = "externalAuthorName", source = "externalAuthor.fullName")
